   ...
   /**
	...
	//			System.out.println(" Seed:"+randomseed );
				...
				if(!appt1.getValid())continue;
				 ...
				 appt1.setStartHour(ValuesGenerator.getRandomIntBetween(random, 70, 80));
				 assertFalse(appt1.getValid());
				 appt1.setStartHour(ValuesGenerator.getRandomIntBetween(random, 1, 10));
				 appt1.setStartMinute(-1);
				 appt1.setStartMinute(ValuesGenerator.getRandomIntBetween(random, 70, 80));
				 assertFalse(appt1.getValid());
				 appt1.setStartMinute(ValuesGenerator.getRandomIntBetween(random, 1, 50));
				 appt1.setStartMonth(-1);
				 appt1.setStartMonth(ValuesGenerator.getRandomIntBetween(random, 70, 80));
				 assertFalse(appt1.getValid());
				...
				//appt1.setStartYear(-1);
				 appt1.setStartDay(-1);
				 appt1.setStartDay(ValuesGenerator.getRandomIntBetween(random, 70, 80));
